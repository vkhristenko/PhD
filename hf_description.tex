...
structure with an inner radius of 12.5 cm to accommodate the beam pipe, an outer radius of 130.0\UNIT{cm},
and with the front face located 11.15\UNIT{m} from the interaction point. Both calorimeters are wrapped
by hermetic radiation shielding of 40 cm thick steel, 40\UNIT{cm} of concrete, and 5\UNIT{cm} of polyethylene,
...
composed of 5\UNIT{mm} thick grooved steel plates that perform as absorbers. The plate grooves run
parallel to the beam line and are spaced 5.0 $\pm$ 0.1\UNIT{mm} center-to-center, each housing a single
optical fiber. Each fiber consists of a fused-silica, also referred to as quartz, core of 600 $\pm$
10\UNIT{mum} diameter, layered to an outer diameter of 630 $^{+5}_{-10}$\UNIT{mum} with polymer hard-clad, and
surrounded to a final diameter of 800 $\pm$ 30\UNIT{mum} with protective acrylate buffer. The optical
...
\begin{figure}[htb]
   \begin{center}
      ...
      125\UNIT{mm} to 1300\UNIT{mm} in the radial direction and measures 1650\UNIT{mm} in the beam direction~\cite{HFCC:2008}. The bundled
      ...
      in the readout boxes. The beam intersection point is located 11.15\UNIT{m} from the front end of the
      calorimeter to the right. All dimensions are in mm.}
      \label{fig:HF_Calo}
   \end{center}
\end{figure}

Cherenkov light forms the signal from charged shower particles above the Cherenkov threshold (E $\ge$
...
\begin{figure}[htb]
   \begin{center}
      ...
      \subfigure[]{
         \includegraphics[width=.35\textwidth]{figures/ch_hfcalibration/HFTower_Fibers.png}
      }
...
It can be seen in Figure~\ref{fig:HFWedge_Diagram} that the geometry of each tower
...
\begin{table}[htb] \centering \scalebox{1.10}{
  ...
  and what fiber bundle is being read out. A match means that the type of fiber bundle being read out
  is the same as the optical fiber the source tube replaced, i.e. EM channel is being read out and
  the source tube occupies an EM fiber groove.}
  \label{tab:HF_GCFactors}
\end{table}
