...
To help better illustrate how the data-taking process went and what kind of objects we are working with upon collecting the data, we refer to Figure~\ref{fig:hf_campaigns_histograms}.

\begin{figure}[!h]
    \begin{center}
        \subfigure[]
        {
            \includegraphics[width=.5\textwidth]{figures/ch_hfcalibration/Signal_ReelPos.png}
        }
        \subfigure[]
        {
            \includegraphics[width=.5\textwidth]{figures/ch_hfcalibration/Signal_Histogram.png}
        }
        \caption
